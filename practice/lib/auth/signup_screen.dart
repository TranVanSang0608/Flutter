                    ...
                    children: [
                        ...
                        child: ClipRRect(
                          ...
                          child: _imageFile != null
                            ...
                            fit: BoxFit.cover,
                              ...
                              : Container(
                            color: const Color(0xffF0EFFF), // Background color for the placeholder
                            width: 100, // Adjust size as needed
                            height: 100,
                            child: Center(
                              child: Icon(
                            ...
                            Wrap(
                              ...
                              children: ['Patient', 'Doctor'].map((String type) {
                                ...
                                return ChoiceChip(
                                  ...
                                  label: Text(type),
                                  selected: isSelected,
                                  selectedColor: const Color(0xff0064FA), // Background color when selected
                                  backgroundColor: const Color(0xffF0EFFF), // Background color when not selected
                                  labelStyle: GoogleFonts.poppins(
                                    color: isSelected ? Colors.white : const Color(0xff0064FA), // Text color
                                  ),
                                  shape: RoundedRectangleBorder(
                                    borderRadius: BorderRadius.circular(20.0), // Rounded corners
                                    side: BorderSide(
                                      color: isSelected ? const Color(0xff0064FA) : const Color(0xff0064FA), // Border color
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton(
                          ...
                          style: ElevatedButton.styleFrom(
                            backgroundColor: const Color(0xffFA9600), // Background color (blue)
                            shape: RoundedRectangleBorder(
                              borderRadius: BorderRadius.circular(10.0), // Rounded corners
                            ),
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton(
                          onPressed: _register,
                          style: ElevatedButton.styleFrom(
                            backgroundColor: const Color(0xff0064FA), // Background color (blue)
                            shape: RoundedRectangleBorder(
                              borderRadius: BorderRadius.circular(10.0), // Rounded corners
                            ),
                            padding: const EdgeInsets.symmetric(vertical: 14), // Vertical padding
